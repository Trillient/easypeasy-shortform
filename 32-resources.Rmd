...
[Center for Humane Technology](https://www.humanetech.com/) - attention-aware technology advocacy

[r/nosurf](https://www.reddit.com/r/nosurf/) - community notes on compulsive internet use

[r/digitalminimalism](https://www.reddit.com/r/digitalminimalism/) - community notes on deliberate technology use
...
[Apple Screen Time](https://support.apple.com/guide/iphone/set-schedules-with-screen-time-iphb0c7313c9/ios) - device-level app limits

[Android Digital Wellbeing](https://support.google.com/android/answer/9346420?hl=en) - device-level app limits

[Freedom](https://freedom.to/) and [one sec](https://one-sec.app/) - optional blockers if you want friction after removing the brainwashing

## REBT Coping Statements {-}

- *“I can stop short-form loop, even though it appears ‘hard' to do so. It’s not too hard, and no matter how much trouble it takes, it’s worth it!”*

- *“If I keep ignoring and never giving in to my powerful urges to short-form loop, I will make it easier and easier to resist them.”*

- *“I can fully and unconditionally accept myself — yes, even with all my flaws and failings.”*

- *“short-form loop seems to quickly ‘cure' my problems, but actually makes them worse.”*

- *“At times, I'd like very much to drown my troubles in short-form loop, but that is never a reason to do so.”*
...
- *“I hate like hell being anxious and depressed, but I don't have to immediately dissolve these feelings with short-form loop. When short-form binging, I temporarily feel better about my problems, but I don't get better. In the long run, short-form loop makes them worse.”*
